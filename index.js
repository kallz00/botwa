...
/////////////////
const BotName = 'KALLZ BOT☄'; 
const instagram = 'https://instagram.com/hi.kallz'; 
const telegram = 'https://t.me/kallz01'; 
const kapanbotaktif = 'Bot aktif dari jam 7 pagi sampai jam 3 sore'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@hi.kallz')
